...
```{r}
tableall <- rename(tableall,  enginenum = 'Aircraft: Number of engines?', birdcollect = "Remains of wildlife collected?", iswarned = "Pilot warned of birds or wildlife?", cost = "Cost: Total $", islarge = "Is Aircraft Large?")
```
...
INSERT INTO incident (recordid, remark , datetoday , cost , peopleinjured , damage , impact ,
  altitude , aboveground , flightphase, iswarned , precipitationid , sky , enginenum , airline,
  airport , birdinfoid, model)
SELECT `Record ID`, Remarks, FlightDate, cost, `Number of people injured`, `Effect: Indicated Damage`, `Effect: Impact to flight`, `Altitude bin`, `Feet above ground`, `When: Phase of flight`, iswarned, precipitationid, 
`Conditions: Sk`y, enginenum,` Aircraft: Airline/Operator`, airport , 
birdinfoid, 
model
```
