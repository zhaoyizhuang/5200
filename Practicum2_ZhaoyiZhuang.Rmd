...
## Create and Populate Journal table and add JID to Article. Assumption: The PubDate is the date for pubmed: date the citation was added to PubMed.
```{r}
